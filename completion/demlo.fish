...
complete -c demlo -o h -x -d "Show script help" -a "$system_script_cmd $user_script_cmd"
...
complete -c demlo -o r -x -d "Remove scripts" -a "$system_script_cmd $user_script_cmd"
